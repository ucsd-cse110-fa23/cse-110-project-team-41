...
public class QuickStart {
   public static void main( String[] args ) {
       ...
       try (MongoClient mongoClient = MongoClients.create(uri)) {
           ...
           addRecipeFile(collection, "/Users/tharun/cse-110-project-team-41/src/recipe.txt" );
       } catch (Exception e){
        e.printStackTrace();
       } 
            /* 
    ...
    private static void addRecipeFile(MongoCollection<Document> collection, String fp){
