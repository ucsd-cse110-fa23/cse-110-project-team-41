 ...
 */
public class Model {
    public String performRequest(String method, File mealTime, File ingredients, String postType, String recipeName,
            String details) {
        String response = "";
        try {
            ...
            if (method.equals("POST")) {
                ...
                if (postType.equals("mealTime")) {
                    writer.append(
                            "Content-Disposition: form-data; name=\"file\"; filename=\"" + mealTime.getName() + "\"")
                            .append(CRLF);
                    writer.append("Content-Length: " + mealTime.length()).append(CRLF);
                    writer.append("Content-Length: " + mealTime.length()).append(CRLF);
                    writer.append("Content-Type: " + connection.guessContentTypeFromName(mealTime.getName()))
                            .append(CRLF);
                    ...
                    writer.append(
                            "Content-Disposition: form-data; name=\"file\"; filename=\"" + ingredients.getName() + "\"")
                            .append(CRLF);
                    writer.append("Content-Length: " + ingredients.length()).append(CRLF);
                    writer.append("Content-Length: " + ingredients.length()).append(CRLF);
                    writer.append("Content-Type: " + connection.guessContentTypeFromName(ingredients.getName()))
                            .append(CRLF);
                    writer.append("Content-Transfer-Encoding: binary").append(CRLF);
                    writer.append("Content-Transfer-Encoding: binary").append(CRLF);
                    writer.append(CRLF).flush();
