...
public class Whisper {
    ...
    private static final String TOKEN = "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";
    ...
    public String main(File args) throws IOException, URISyntaxException { 
        String transcribed = "";
